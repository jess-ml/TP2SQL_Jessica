...
-- Création de la fonction GET_NB_WORKERS
...
-- Création de la fonction GET_NB_BIG_ROBOTS
...
-- Création de la fFonction GET_BEST_SUPPLIER
...
-- Création de la fonction GET_OLDEST_WORKER
...
-- Création de la Procédure SEED_DATA_WORKERS
