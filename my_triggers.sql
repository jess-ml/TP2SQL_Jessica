-- Trigger de  l'insertion dans ALL_WORKERS_ELAPSED
...
-- Trigger le l'enregistrer la date d’ajout de robot
...
-- Trigger qui empêche la modification si nombre d'usines ≠ nombre de tables
...
-- Trigger du  calcul de la durée de travail
